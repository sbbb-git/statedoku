...
const GAMES = [
  ...
  { slug:'state-capitals-match', playable:true, group:'classic',
    ...
    chip:'🏛️ CAPITALS'},
  { slug:'state-silhouettes', playable:true, group:'interactive',
    ...
    chip:'🔳 SILHOUETTES'},
  { slug:'states-connections', playable:true, group:'interactive',
  ...
  // Classic quizzes
  { slug:'state-capitals-typing', playable:true, group:'classic',
  ...
  { slug:'biggest-cities', playable:true, group:'classic',
    ...
    chip:'🏙️ BIG CITIES'},
  { slug:'state-flags', playable:true, group:'classic',
  ...
  // History quizzes
  { slug:'thirteen-colonies', playable:true, group:'history',
    ...
    chip:'🌲 13 COLONIES'},
  { slug:'state-admission-order', playable:true, group:'history',
    ...
    chip:'⏳ STATEHOOD'},
  { slug:'confederate-states', playable:true, group:'history',
  ...
  { slug:'president-birth-states', playable:true, group:'history',
  ...
  // Symbol quizzes
  { slug:'state-nicknames', playable:true, group:'symbols',
    ...
    chip:'✨ NICKNAMES'},
  { slug:'state-mottos', playable:true, group:'symbols',
    ...
    chip:'📜 MOTTOS'},
  { slug:'state-symbols', playable:true, group:'symbols',
  ...
  // Advanced geography
  { slug:'time-zones', playable:true, group:'geography',
    ...
    chip:'⏰ TIME ZONES'},
  { slug:'border-states', playable:true, group:'geography',
    ...
    chip:'🌎 BORDERS'},
  { slug:'rivers-mountains', playable:true, group:'geography',
  ...
  // Politics
  { slug:'electoral-college', playable:true, group:'politics',
    ...
    chip:'🗳️ ELECTORAL'},
  { slug:'swing-states', playable:true, group:'politics',
    ...
    chip:'⚖️ SWING'},
  { slug:'no-income-tax-states', playable:true, group:'politics',
