...
export async function onRequestGet({ request }) {
  ...
  // Only the hub. The 101 per-city pages are noindexed (102-122 words each,
  // ranking position 55-70 for tourism queries that Wikipedia and travel
  // sites own), so listing them here submitted 101 URLs to Google that then
  // told it not to index them. Conflicting signal plus wasted crawl budget.
  ...
  const extras = [
    ...
    // /play/ hub + games (Wave 1, June 19) — 66 pages
    [`${BASE}/play/`, { priority: 0.95, changefreq: 'weekly' }],
    [`${BASE}/fr/play/`, { priority: 0.95, changefreq: 'weekly' }],
    [`${BASE}/es/play/`, { priority: 0.95, changefreq: 'weekly' }],
    [`${BASE}/play/place-the-state/`, { priority: 0.9, changefreq: 'weekly' }],
    [`${BASE}/fr/play/place-the-state/`, { priority: 0.9, changefreq: 'weekly' }],
    [`${BASE}/es/play/place-the-state/`, { priority: 0.9, changefreq: 'weekly' }],
    [`${BASE}/play/state-abbreviations/`, { priority: 0.9, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-abbreviations/`, { priority: 0.9, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-abbreviations/`, { priority: 0.9, changefreq: 'weekly' }],
    [`${BASE}/play/state-capitals-match/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-capitals-match/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-capitals-match/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/state-silhouettes/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-silhouettes/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-silhouettes/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/states-connections/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/states-connections/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/states-connections/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/state-capitals-typing/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-capitals-typing/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-capitals-typing/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/biggest-cities/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/biggest-cities/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/biggest-cities/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/state-flags/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-flags/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-flags/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/thirteen-colonies/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/thirteen-colonies/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/thirteen-colonies/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/state-admission-order/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-admission-order/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-admission-order/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/confederate-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/confederate-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/confederate-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/president-birth-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/president-birth-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/president-birth-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/state-nicknames/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-nicknames/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-nicknames/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/state-mottos/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-mottos/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-mottos/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/state-symbols/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/state-symbols/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/state-symbols/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/time-zones/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/time-zones/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/time-zones/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/border-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/border-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/border-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/rivers-mountains/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/rivers-mountains/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/rivers-mountains/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/electoral-college/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/electoral-college/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/electoral-college/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/swing-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/swing-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/swing-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/play/no-income-tax-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/fr/play/no-income-tax-states/`, { priority: 0.7, changefreq: 'weekly' }],
    [`${BASE}/es/play/no-income-tax-states/`, { priority: 0.7, changefreq: 'weekly' }],
  ];
  ...
  const SHABBAT_FR = ['etats-par-pib','fleuves-par-etat-americain','montagne-plus-haute-par-etat','etats-les-plus-surs','etats-plus-d-immigrants','etats-moins-chers-vivre','etats-catastrophes-naturelles','etats-niveau-etudes'];
